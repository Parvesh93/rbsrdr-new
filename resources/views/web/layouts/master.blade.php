...
<body>
    <div class="top-bar top-b text-center">
        @isset($collegesInfo)
    ...
    <img class="logo-img"
        src="{{ asset('/uploads/setting-second/' . $setting->logo_path) }}"
        alt="Logo">
</a>
            @endif
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="tb-buttons">
                    ...
                    <a href="#" class="btn btn-sm mx-1" data-bs-toggle="modal"
                        data-bs-target="#enquiryStudent">Apply Now</a>

                    <!-- Enquiry Form Modal -->
                    <div class="modal fade" id="enquiryStudent" tabindex="-1" aria-labelledby="enquiryModalLabel"
                        aria-hidden="true">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="">
                        ...
                        <p>
                            R.B.S.R.D.R College IS THE LATEST SYMBOL OF THE
