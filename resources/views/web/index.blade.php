            ...
            <div class="hero-slider">
                ...
                {{-- <div class="slide" style="background-image: url('images/home/slide_2.jpg')">
                    <div class="slide-content">
                        ...
                        <p>
                            At RBSRDR College our vision is to be recognized globally as a beacon of
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        <div class="feature-item">
                            ...
                            <p>
                                At RBSRDR College We are Having Highly Qualified And Experienced
                                Lecturers.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-2">
                        <div class="feature-item">
                            ...
                            <p>Student Credit Card Facilities Available at RBSGOI.</p>
                        </div>
                    </div>
                    <!-- Feature 3 -->
                    <div class="col-md-4">
         ...
         <section class="info-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="info-box">
                            <h3 class="info-title">Welcome at RBSRDR</h3>
                            <ul class="info-list">
                    ...
                    <div class="mb-4">
                        @foreach ($institutes as $inst)
                            ...
                            <p class="description">
                               ...
                               <!--RBSRDR stands as a testament to the visionary leadership of our Founder Director, Hon’ble Shri Sanjay Kumar Rai. In a short span, it has achieved remarkable progress, demonstrating a high level of academic excellence.-->

<!--RBSRDR is committed to aligning itself with the latest educational content and innovative teaching methodologies. Our mission is to cultivate competent, passionate, and industry-ready professionals who excel in human resource management, business operations, and the implementation of world-class practices with unwavering dedication and commitment.-->
                    ...
                    <div>
                        <div class="enquiry">
                            <h3 class="text-left mb-4 enquiry-heading">Enquiry Form</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="mb-3">
                                     <button type="submit" class="form-btn btn-primary w-100">
                                      Submit
                                     </button>
                                </div>
        ...
        <section class="courses-section">
            <div class="container">
                <h2 class="section-title">Courses Offered at RBSRDR College</h2>
            ...
            <section class="vision-mission-section py-5">
                <div class="container">
                    <div class="row">
                        ...
                        <div>
                            <!-- Vision -->
                            <div class="mri-card mb-4 p-4 shadow-sm border-0">
                                <div class="card-body">
                            ...
                            <!-- Mission -->
                            <div class="mri-card p-4 mb-3 shadow-sm border-0">
                                <div class="card-body">
                                    <h3 class="card-title fw-bold text-uppercase text-white">
                                        {{ $about->mission_title }}
                                    </h3>
        ...
        <div class="row g-3">
            ...
            <div class="col-6 col-lg-3 mb-3">
                <div class="text-center align-items-center">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold">20+ years of excellence</h6>
                        <p class="mb-0 text-muted">in the field of education</p>
                    </div>
                </div>
            </div>
  ...
  <div class="container">
    ...
    @foreach ($missions as $mission)
      ...
      <div class="col-6 col-md-3 d-flex justify-content-center">
        <div class="octagon-card stats-card">
          <div class="octagon-icon"><img src="{{ asset('uploads/gallery/' . $mission->attach) }}"
                                        alt="Instructors Icon" /></div>
          <h4 class="octagon-title mrbs">{{ $mission->description }}</h4>
          <p class="octagon-subtitle mrbs">{{ $mission->title }}</p>
        </div>
      ...
      <!--    <div class="octagon-icon"><i class="fas fa-video"></i></div>-->
      <!--    <h4 class="octagon-title">25</h4>-->
      <!--    <p class="octagon-subtitle">Live Sessions/Month</p>-->
      <!--  </div>-->
      <!--</div>-->
      ...
      <!--<div class="col-6 col-md-3 d-flex justify-content-center">-->
      <!--  <div class="octagon-card">-->
      <!--    <div class="octagon-icon"><i class="fas fa-graduation-cap"></i></div>-->
      <!--    <h4 class="octagon-title">87</h4>-->
      <!--    <p class="octagon-subtitle">New Courses/Year</p>-->
      <!--  </div>-->
      <!--</div>-->
      ...
      <!--<div class="col-6 col-md-3 d-flex justify-content-center">-->
      <!--  <div class="octagon-card">-->
      <!--    <div class="octagon-icon"><i class="fas fa-user-tie"></i></div>-->
      <!--    <h4 class="octagon-title">50</h4>-->
      <!--    <p class="octagon-subtitle">Professional Instructors</p>-->
      <!--  </div>-->
      <!--</div>-->
                ...
                <div class="container">
                    <div class="facilities-section py-5">
                        <div class="facilities-header text-center mb-5">
                            <h2>Be at RBSRDR College Best in Academics & Educational Facilities</h2>
                            ...
                            <p class="facilities-highlight fw-bold">
                                RBSRDR College Mahnar | Top College in Vaishali, Bihar
                            </p>
                        </div>
