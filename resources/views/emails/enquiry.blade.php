...
<body>
    <div class="container">
        ...
        <div class="details">
            ...
            <p><strong>Email:</strong> <span id="student-email">{{$data['email']}}</span></p>
            <p><strong>Phone Number:</strong> <span id="student-phone">{{$data['contact']}}</span></p>
            <p><strong>Ref Persion:</strong> <span id="student-ref-persion">{{$data['ref_persion']}}</span></p>
            <p><strong>How did you hear about us:</strong> <span id="studen-here-me">{{$data['here_me']}}</span></p>
            ...
            <p><strong>Additional Details:</strong> <span id="student-details">{{$data['address']}}</span></p>
        </div>
    </div>
