                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="year" id="year">
                                ...
                                <option value="1st" @if ($row->year == '1st') selected @endif>
                                    {{ __('1st_year') }}
                                </option>

                                <option value="2nd" @if ($row->year == '2nd') selected @endif>
                                    {{ __('2nd_year') }}
                                </option>

                                <option value="3rd" @if ($row->year == '3rd') selected @endif>
                                    {{ __('3rd_year') }}
                                </option>

                                <option value="4th" @if ($row->year == '4th') selected @endif>
                                    {{ __('4th_year') }}
                                </option>

                                <option value="5th" @if ($row->year == '5th') selected @endif>
                                    {{ __('5th_year') }}
                                </option>

                                <option value="6th" @if ($row->year == '6th') selected @endif>
                                    {{ __('6th_year') }}
                                </option>

                                <option value="7th" @if ($row->year == '7th') selected @endif>
                                    {{ __('7th_year') }}
                                </option>

                                <option value="8th" @if ($row->year == '8th') selected @endif>
                                    {{ __('8th_year') }}
                                </option>
                            </select>
