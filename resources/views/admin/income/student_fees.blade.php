                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form class="needs-validation" novalidate method="get"
                                action="{{ route('admin.collection.datafees') }}">
                                <div class="row gx-2">
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="table-responsive">
                                    <table id="export-table1" class="display table nowrap table-striped table-hover"
                                        style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Serial No
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @foreach ($row->cashReceived as $key => $cash)
                                                            <div>
                                                                <span
                                                                    class="badge badge-danger">{{ $cash->cash_amount }}</span>
                                                            </div>
                                                        @endforeach
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        @foreach ($row->bankReceived as $key => $bank)
                                                            <div>
                                                                <span
                                                                    class="badge  badge-success">{{ $bank->bank_amount }}</span>
                                                            </div>
                                                        @endforeach
                                                    </td>
                                                    <td>
                                                        @foreach ($row->bankReceived as $key => $bank)
                                                            <div>
                                                                <span
                                                                    class="badge  badge-success">{{ $bank->bank_date }}</span>
                                                            </div>
                                                        @endforeach
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        @foreach ($row->bankReceived as $key => $bank)
                                                            <div>
                                                                <span
                                                                    class="badge badge badge-success">{{ $bank->bank_name }}</span>
                                                            </div>
                                                        @endforeach
                                                    </td>
                                                    ...
                                                    <td>
                                                        @foreach ($row->refrences as $key => $refrence)
                                                            <div>
                                                                <span
                                                                    class="badge badge-primary">{{ $refrence->ref_amount }}</span>
                                                            </div>
                                                        @endforeach
                                                    </td>
                                                    <td>
                                                        @foreach ($row->refrences as $key => $refrence)
                                                            <div>
                                                                <span
                                                                    class="badge badge-primary">{{ $refrence->ref_date }}</span>
                                                            </div>
                                                        @endforeach
                                                    </td>
                                                    <td>
                                                        @foreach ($row->refrences as $key => $refrence)
                                                            <div>
                                                                <span
                                                                    class="badge badge-primary">{{ $refrence->utr_no }}</span>
                                                            </div>
                                                        @endforeach
                                                    </td>
                                                    <td>
                                                        @foreach ($row->refrences as $key => $refrence)
                                                            <div>
                                                                <span
                                                                    class="badge badge-primary">{{ $refrence->ref_name }}</span>
                                                            </div>
                                                        @endforeach
                                                    </td>
                                                    ...
                                                    @if (!empty($row->total_amounts))
                                                        <td><span class="badge badge-primary">{{ $row->total_amounts }}</span>
                                                        </td>
                                                    @else
