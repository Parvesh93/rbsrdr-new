...
<div class="navbar-content scroll-div ps ps--active-y">
    <ul class="nav pcoded-inner-navbar">
        ...
        @canany(['application-create', 'application-view', 'student-create', 'student-view', 'student-import',
            'student-password-print', 'student-password-change', 'student-card', 'student-transfer-in-create',
            'student-transfer-in-view', 'student-transfer-out-create', 'student-transfer-out-view', 'status-type-create',
            'status-type-view', 'id-card-setting-view'])
                ...
                <ul class="pcoded-submenu">
                    ...
                    @canany(['student-view', 'student-password-print', 'student-password-change', 'student-card',
                        ...
                        <li class="{{ Request::is('admin/admission/cancel-student') ? 'active' : '' }}"><a
                                href="{{ route('admin.student.cancel') }}"
                                class="">{{ trans_choice('module_cancel_student', 1) }}</a></li>
                    @endcanany
        ...
        @if (auth()->user()->is_admin === 1)
            @canany(['bilash-clc-create', 'bilash-clc-view', 'kanchan-clc-create', 'kanchan-clc-view',
                'nursing-clc-create', 'nursing-clc-view', 'bilash-provisional-create', 'bilash-provisional-view',
                'nursing-provisional-create', 'nursing-provisional-view', 'kanchan-provisional-create',
                'kanchan-provisional-view'])
                <li
                    class="nav-item pcoded-hasmenu {{ Request::is('admin/bilash-clc*') ||
                    Request::is('admin/kanchan-clc*') ||
                    Request::is('admin/nursing-clc*') ||
                    Request::is('admin/bilash-provisional*') ||
                    Request::is('admin/nursing-provisional*') ||
                    Request::is('admin/kanchan-provisional*')
                    ...
                    <ul class="pcoded-submenu">
                        @canany(['bilash-clc-create', 'bilash-clc-view', 'kanchan-clc-create', 'kanchan-clc-view',
                            'nursing-clc-create', 'nursing-clc-view'])
                            <li
                                class="nav-item pcoded-hasmenu {{ Request::is('admin/bilash-clc*') || Request::is('admin/kanchan-clc*') || Request::is('admin/nursing-clc*')
                                    ? 'pcoded-trigger active'
                                    : '' }}">
                                ...
                                <ul class="pcoded-submenu">
                                    @canany(['bilash-clc-create', 'bilash-clc-view'])
                                        <li class="{{ Request::is('admin/bilash-clc*') ? 'active' : '' }}"><a
                                                href="{{ route('admin.bilash-clc.index') }}"
                                                class="">{{ trans_choice('module_bilash_clc', 2) }}</a></li>
                                    @endcanany

                                    @canany(['kanchan-clc-create', 'kanchan-clc-view'])
                                        <li class="{{ Request::is('admin/kanchan-clc*') ? 'active' : '' }}"><a
                                                href="{{ route('admin.kanchan-clc.index') }}"
                                                class="">{{ trans_choice('module_kanchan_clc', 2) }}</a></li>
                                    @endcanany
                        ...
                        @canany(['bilash-provisional-create', 'bilash-provisional-view', 'nursing-provisional-create',
                            'nursing-provisional-view', 'kanchan-provisional-create', 'kanchan-provisional-view'])
                            <li
                                class="nav-item pcoded-hasmenu {{ Request::is('admin/bilash-provisional*') ||
                                Request::is('admin/nursing-provisional*') ||
                                Request::is('admin/kanchan-provisional*')
                                    ? 'pcoded-trigger active'
                                    : '' }}">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    @canany(['bilash-provisional-create', 'bilash-provisional-view'])
                                        <li class="{{ Request::is('admin/bilash-provisional*') ? 'active' : '' }}"><a
                                                href="{{ route('admin.bilash-provisional.index') }}"
                                                class="">{{ trans_choice('module_bilash_provisional', 2) }}</a></li>
                                    @endcanany

                                    @canany(['kanchan-provisional-create', 'kanchan-provisional-view'])
                                        <li class="{{ Request::is('admin/kanchan-provisional*') ? 'active' : '' }}"><a
                                                href="{{ route('admin.kanchan-provisional.index') }}"
                                                class="">{{ trans_choice('module_kanchan_provisional', 2) }}</a></li>
                                    @endcanany
            ...
            @canany(['bilash-clc-create', 'bilash-clc-view', 'kanchan-clc-create', 'kanchan-clc-view',
                ...
                <li
                    ...
                    <ul class="pcoded-submenu">
                        @canany(['bilash-clc-create', 'bilash-clc-view', 'kanchan-clc-create', 'kanchan-clc-view',
                            ...
                            <li
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    @if ($departmentCondition->degree_id === auth()->user()->college_department_id)
                                        @canany(['bilash-clc-create', 'bilash-clc-view'])
                                            <li class="{{ Request::is('admin/bilash-clc*') ? 'active' : '' }}"><a
                                                    href="{{ route('admin.bilash-clc.index') }}"
                                                    class="">{{ trans_choice('module_bilash_clc', 2) }}</a></li>
                        ...
                        @canany(['kanchan-provisional-create', 'kanchan-provisional-view', 'bilash-provisional-create',
                            'bilash-provisional-view', 'nursing-provisional-create', 'nursing-provisional-view'])
                            <li
                                class="nav-item pcoded-hasmenu {{ Request::is('admin/bilash-provisional*') || Request::is('admin/kanchan-provisional*') || Request::is('admin/nursing-provisional*') ? 'pcoded-trigger active' : '' }}">
                                <a href="#!" class="nav-link">
                                    <span class="pcoded-mtext">{{ trans_choice('module_provisional', 2) }}</span>
                                </a>
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    @if ($departmentCondition->degree_id === auth()->user()->college_department_id)
                                        ...
                                        @canany(['kanchan-provisional-create', 'kanchan-provisional-view'])
                                            <li class="{{ Request::is('admin/kanchan-provisional*') ? 'active' : '' }}"><a
                                                    href="{{ route('admin.kanchan-provisional.index') }}"
                                                    class="">{{ trans_choice('module_kanchan_provisional', 2) }}</a>
                                            </li>
                                        @endcanany
                                    @elseif($departmentCondition->nursing_id === auth()->user()->college_department_id)
        ...
        @canany(['college-department-create', 'college-department-view', 'faculty-create', 'faculty-view',
            ...
            <li
                class="nav-item pcoded-hasmenu {{ Request::is('admin/academic*') || Request::is('admin/department/condition*') || Request::is('admin/department/program-condition*') ? 'pcoded-trigger active' : '' }}">
                <a href="#!" class="nav-link">
                ...
                <ul class="pcoded-submenu">
                    ...
                    @canany(['department-condition-view'])
                        <li class="{{ Request::is('admin/department/program-condition*') ? 'active' : '' }}"><a
                                ...
                                class="">{{ trans_choice('module_program_condition', 2) }}</a></li>
                    @endcanany
        ...
        @canany(['fees-student-due', 'fees-student-quick-assign', 'fees-student-quick-received', 'fees-student-report',
            ...
            <li class="nav-item pcoded-hasmenu {{ Request::is('admin/fees*') ? 'pcoded-trigger active' : '' }}">
                ...
                <ul class="pcoded-submenu">
                    ...
                    @can('fess/special/student')
                        <li class="{{ Request::is('admin/fess/special/student*') ? 'active' : '' }}"><a
        ...
        @canany(['user-create', 'user-view', 'user-password-print', 'user-password-change', 'staff-note-create',
            ...
            'department-view', 'tax-setting-create', 'tax-setting-view', 'pay-slip-setting-view' ,'staff-card'])
            <li class="nav-item pcoded-hasmenu {{ Request::is('admin/staff*') ? 'pcoded-trigger active' : '' }}">
                ...
                <ul class="pcoded-submenu">
                    @canany(['user-create', 'user-view', 'user-password-print', 'user-password-change'])
                        <li class="{{ Request::is('admin/staff/user*') || Request::is('admin/staff-id-card*') ? 'active' : '' }}"><a
                    ...
                    @canany(['staff-card'])
                        <li class="{{ Request::is('admin/staff-id-card*') ? 'active' : '' }}"><a
                                href="{{ route('admin.staff-id-card.index') }}"
                                class="">{{ "Employees ID Card" }} {{ __('list') }}</a></li>
                    @endcanany
                ...
                <ul class="pcoded-submenu">
                    ...
                    @canany(['income-create', 'income-view'])
                        <li class="{{ Request::is('admin/account/fees-collection*') ? 'active' : '' }}"><a
                                href="{{ route('admin.income.feesCollection') }}" class="">{{ 'Student Fees Collection' }}
                                {{ __('list') }}</a></li>
                    @endcanany
