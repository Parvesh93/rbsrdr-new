                                  ...
                                  @endphp
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         @forelse($row->refrences ?? [] as $refrence)
                                            <div>
                                            ...
                                            @empty
                                            <span class="text-muted">No RefReceived</span>
                                          @endforelse
                                        </td>
                                        <td>
                                         ...
                                         @forelse($row->refrences ?? [] as $refrence)
                                            ...
                                            @empty
                                            <span class="text-muted">No RefDate</span>
                                          @endforelse
                                        </td>
                                        <td>
                                         ...
                                         @forelse($row->refrences ?? [] as $refrence)
                                            ...
                                            @empty
                                            <span class="text-muted">No RefUTR_No</span>
                                          @endforelse
                                        </td>
                                        <td>
                                         ...
                                         @forelse($row->refrences ?? [] as $refrence)
                                            ...
                                            @empty
                                            <span class="text-muted">No RefName</span>
                                          @endforelse
                                        </td>
                                        <td>
                                            
                                            
                                         @forelse($row->cashReceived ?? [] as $cash)
                                            <div>
                                            ...
                                            @empty
                                            <span class="text-muted">No CashReceived</span>
                                          @endforelse
                                        </td>
                                        <td>
                                         ...
                                         @forelse($row->cashReceived ?? [] as $cash)
                                            ...
                                            @empty
                                            <span class="text-muted">No CashDate</span>
                                          @endforelse
                                        </td>
                                        <td>
                                         ...
                                         @forelse($row->cashReceived ?? [] as $cash)
                                            ...
                                            @empty
                                            <span class="text-muted">No CashUTR_No</span>
                                          @endforelse
                                        </td>
                                        <td>
                                         ...
                                         @forelse($row->cashReceived ?? [] as $cash)
                                            ...
                                            @empty
                                            <span class="text-muted">No CashRefName</span>
                                          @endforelse
                                        </td>
                                        <td>
                                         ...
                                         @forelse($row->bankReceived ?? [] as $bank)
                                            <div>
                                            ...
                                            @empty
                                            <span class="text-muted">No BankReceived</span>
                                          @endforelse
                                        </td>
                                        <td>
                                         ...
                                         @forelse($row->bankReceived ?? [] as $bank)
                                            ...
                                            @empty
                                            <span class="text-muted">No BankDate</span>
                                          @endforelse
                                        </td>
                                        <td>
                                         ...
                                         @forelse($row->bankReceived ?? [] as $bank)
                                           @if (!empty($bank->bank_name))
                                            ...
                                            @endif
                                            @empty
                                            <span class="text-muted">No BankUTR_No</span>
                                          @endforelse
                                        </td>
                                    <td>
                                        ...
                                        @forelse($row->bankReceived ?? [] as $bank)
                                            ...
                                            @endif
                                        @empty
                                            <span class="text-muted">No BankRefName</span>
                                        @endforelse
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @empty
                                            <span class="text-muted">No DeductionsFound</span>
                                        @endforelse
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @empty
                                            <span class="text-muted">No DeductionsDate</span>
                                        @endforelse
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @forelse($row->deductions ?? [] as $deduction)
                                            <div>
                                                <span class="badge badge-warning">
                                                    {{ $deduction->deduction->utr_no }}
                                                </span>
                                            </div>
                                        @empty
                                            <span class="text-muted">No DeductionsUtrNo</span>
                                        @endforelse
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @empty
                                            <span class="text-muted">No DeductionsRefName</span>
                                        @endforelse
                                    </td>
