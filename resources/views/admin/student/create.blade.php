                                            ...
                                            <fieldset class="row scheduler-border">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="student_id"
                                                        id="student_id" value="{{ old('student_id') }}" required>
                                                ...
                                                @if ($is_admin === 1)
                                                    <div class="form-group col-md-6">
                                                        <label for="program">{{ __('field_program') }}
                                                            <span>*</span></label>
                                                ...
                                                @if ($is_admin === 0)
                                                    <div class="form-group col-md-6">
                                                        <label for="program">{{ __('field_program') }}
                                                            <span>*</span></label>
                                                        <select class="form-control program" name="program" id="program1"
                                                            required>
                                                            <option value="">{{ __('select') }}</option>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="total_course_fees"
                                                        id="total_course_fees" value="{{ old('total_course_fees') }}"
                                                        required>
                                        ...
                                        <fieldset class="row scheduler-border">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="bachelor_total_marks"
                                                    id="bachelor_total_marks" value="{{ old('bachelor_total_marks') }}">
                                        ...
                                        <fieldset class="row scheduler-border">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="master_total_marks"
                                                    id="master_total_marks" value="{{ old('master_total_marks') }}">
                                    ...
                                    <content class="form-step">
                                        ...
                                        <fieldset class="row scheduler-border">
                                            ...
                                            @if (field('application_highschool_certificate')->status == 1)
                                                <div class="form-group col-md-6">
                                                    <label for="high_school_certi">{{ __('field_school_certifiate') }}
                                                        <span>*</span></label>
                                        ...
                                        <fieldset class="row scheduler-border">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="file" class="form-control" name="bonafide_certificate"
                                                    id="bonafide_certificate" value="{{ old('bonafide_certificate') }}">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="file" class="form-control" name="drcc_selection_letter"
                                                    id="drcc_selection_letter"
   ...
   <script type="text/javascript">
    ...
    <script type="text/javascript">
        (function($) {
            ...
            $(document).on('click', '.addSemesterField', function() {

                let course = $(this).data('course');
                let wrapperId = '#semesterFieldWrapper_' + course;
                ...
                // COURSE BASED LOGIC
                if (course === 'bsc_nursing') {
                    labelText = "{{ __('field_semester') }}";
                    marksheetLabel = "Semester Marksheet";
                    optionsHtml = `
                <option value="">{{ __('select') }}</option>
            ...
            `;
                ...
                <option value="6">6rd Year</option>
            `;
                }
                ...
                <option value="5">5nd Year</option>
            `;
                }

                let html = '';
                html += '<hr>';
                html += '<div class="row semesterFieldGroup">';
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control"
                name="semesters[` + course + `][]" required>
                ` + optionsHtml + `
            </select>
            <div class="invalid-feedback">
                {{ __('required_field') }}
                ...
                html += `
        <div class="form-group col-md-6">
            <label>` + marksheetLabel + ` <span>*</span></label>
            <input type="file" class="form-control"
                name="semester_marksheets[` + course + `][]" required>
            <div class="invalid-feedback">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="file" class="form-control"
                name="admit_cards[` + course + `][]">
            <div class="invalid-feedback">
                {{ __('required_field') }} Admit Card
            </div>
        </div>`;
        ...
        <div class="form-group col-md-12">
            ...
            $(document).on('click', '.removeSemesterField', function() {
                $(this).closest('.semesterFieldGroup').remove();
            });
