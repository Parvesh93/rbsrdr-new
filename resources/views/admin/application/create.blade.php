...
<body>
                    ...
                    <div class="card-block">
                        <div class="row mt-5 mb-5">
                            ...
                            <div class="col-sm-8 text-center">
                                ...
                                <h3 class="space-bo"><span class="sub-heading">Email: </span><span
                                        class="heading6">{{ $applicationSetting->email }}</span>|<span
                                        class="sub-heading">Contact No: </span><span
                                        class="heading7">{{ $applicationSetting->contact_no_first }},
                                        {{ $applicationSetting->contact_no_second }}</span> </h3>
                                            ...
                                            <div class="col-md-12">
                                                <fieldset class="row scheduler-border">
                                                    <div class="form-group col-md-6">
                                                        <label for="field_roll">{{ __('field_role_no') }}
                                                            <span>*</span></label>
                                                        <input type="text" class="form-control" name="roll_no"
                                                            id="roll_no" value="Fill by Admin..." disabled>

                                                        <div class="invalid-feedback">
                                                            {{ __('required_field') }} {{ __('field_role_no') }}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                     ...
                                                     <div class="form-group col-md-6">
                                                           ...
                                                           <input type="text" class="form-control" name="refrence_person_contact" id="refrence_person_contact"
                                                           value="{{old('refrence_person_contact')}}">
                                                    ...
                                                    @if (field('application_marital_status')->status == 1)
                                                        <div class="form-group col-md-6">
                                                            <label for="marital_status">{{ __('field_marital_status') }}
                                                                <span>*</span></label>
    ...
    @endif>-->
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="parent_phone">{{ __('field_phone_parents') }}
                                                            <span>*</span></label>
                                                        <input type="text" class="form-control" name="parent_phone"
                                                            id="parent_phone" value="{{ old('parent_phone') }}"
                                                            required>
                                                    ...
                                                    @if (field('application_national_id')->status == 1)
                                                        <div class="form-group col-md-6">
                                                            <label for="national_id">{{ __('field_national_id') }}
                                                                <span>*</span></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control nationality" id="nationality"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <fieldset class="row scheduler-border">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label for="present_address">{{ __('field_address') }}
                                                                <span>*</span></label>
                                                            <input type="text" class="form-control"
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label for="present_post">{{ __('field_post') }}
                                                                <span>*</span></label>
                                                            <input type="text" class="form-control"
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label for="present_police_station">{{ __('field_script') }}
                                                                <span>*</span></label>
                                                            <input type="text" class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset class="row scheduler-border">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label for="permanent_address">{{ __('field_address') }}
                                                                <span>*</span></label>
                                                            <input type="text" class="form-control"
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label for="permanent_post">{{ __('field_post') }}
                                                                <span>*</span></label>
                                                            <input type="text" class="form-control"
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label
                                                                for="permanent_police_station">{{ __('field_script') }}
                                                                <span>*</span></label>
                                                            <input type="text" class="form-control"
                                                ...
                                                <fieldset class="row scheduler-border">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label
                                                            ...
                                                            <span>*</span></label>
                                                        <input type="text" class="form-control"
                                                            name="high_school_total_marks" id="high_school_total_marks"
                                            ...
                                            @if (field('application_bachelor_info')->status == 1)
                                                <fieldset class="row scheduler-border">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="bachelor_total_marks" id="bachelor_total_marks"
                                            ...
                                            @if (field('application_master_info')->status == 1)
                                                <fieldset class="row scheduler-border">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="master_total_marks" id="master_total_marks"
                                                ...
                                                @if (field('application_highschool_certificate')->status == 1)
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="file" class="form-control"
                                                            ...
                                                            value="{{ old('high_school_certi') }}" required>
                                                ...
                                                @if (field('application_intermadiate_certi')->status == 1)
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="file" class="form-control"
                                                            ...
                                                            value="{{ old('intermediate_certi') }}" required>
                                                        {{-- required  --}}
                                                        <div class="invalid-feedback">
                                                            {{ __('required_field') }}
                                                ...
                                                @if (field('application_intermediate_clc')->status == 1)
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="file" class="form-control"
                                                            ...
                                                            value="{{ old('intermediate_clc') }}" required>
                                                        {{-- required  --}}
                                                        <div class="invalid-feedback">
                                                            {{ __('required_field') }}
