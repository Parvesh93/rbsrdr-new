...
class ClassRoutineController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $subjects = Subject::where('status', 1)->where('admission_college',$college);
        ...
        $data['rooms'] = ClassRoom::where('status', '1')->where('admission_college',$college)->orderBy('title', 'asc')->get();

        $teachers = User::where('status', '1')->where('admission_college',$college);
    ...
    public function store(Request $request)
    {
        ...
        if($request->subject){
            ...
            $college=$request->college_status;
            ...
            for($j = 0; $j < $subject_count; $j++){
                ...
                ->where('admission_college',$college)
                ...
                //Period Check
                $period_check = ClassRoutine::where('session_id', $session) ->where('admission_college',$college)->where('program_id', $program)->where('semester_id', $semester)->where('section_id', $section)
                ->where('start_time', $start)
                ->where('day', $day)
                ->first();
    ...
    public function teacher(Request $request)
    {
        ...
        if(!empty($request->teacher) && $request->teacher != Null){
            ...
            $session = Session::where('status', '1')->where('admission_college',$college)->where('current', '1')->first();
