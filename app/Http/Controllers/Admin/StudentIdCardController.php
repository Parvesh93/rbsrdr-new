...
class StudentIdCardController extends Controller
{
    ...
    public function qr(Request $request)
    {
        ...
        $qr = QrCode::size(150)->generate($student_id);
    ...
    public function index(Request $request)
    {
        ...
        if (auth()->user()->is_admin === 1) {
            ...
            if (
                isset($request->faculty) || isset($request->program) || isset($request->session) || isset($request->semester) || isset($request->section) || isset($request->student_id)
