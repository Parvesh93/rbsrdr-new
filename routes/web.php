...
use App\Http\Controllers\Admin\BilashClcController;
use App\Http\Controllers\Admin\KanchanClcController;
use App\Http\Controllers\Admin\NursingClcController;
use App\Http\Controllers\Admin\BilashProvisionalController;
use App\Http\Controllers\Admin\KanchanProvisionalController;
...
Route::middleware(['auth:web', 'XSS'])->name('admin.')->namespace('Admin')->prefix('admin')->group(function () {
    ...
    Route::get('clc/bilash-clc/{id}', [BilashClcController::class, 'clc'])->name('bilash-clc.clc');

    Route::get('clc/kanchan-clc/{id}', [KanchanClcController::class, 'clc'])->name('kanchan-clc.clc');

    Route::get('clc/nursing-clc/{id}', [NursingClcController::class, 'clc'])->name('nursing-clc.clc');

    //Provisional routes
    Route::get('provisional/bilash-provisional/{id}', [BilashProvisionalController::class, 'provisional'])->name('bilash-provisional.provisional');
    Route::get('provisional/kanchan-provisional/{id}', [KanchanProvisionalController::class, 'provisional'])->name('kanchan-provisional.provisional');
    ...
    Route::get('staff/id-card-multiprint', [StaffIdCardController::class, 'multiPrint'])->name('staff-id-card.multiprint');
    ...
    Route::post('fees-student-quick-store', [FeesStudentController::class, 'quickAssignStore'])->name('fees-student.quick.assign.store');
    ...
    //     Route::resource('about-us', 'AboutUsController');s
...
Route::middleware(['auth:web', 'XSS'])->name('admin.')->prefix('admin')
    ->group(function () {
        ...
        Route::resource('bilash-clc', BilashClcController::class);
        Route::resource('kanchan-clc', KanchanClcController::class);

        //Provisional Routes

        Route::resource('nursing-provisional', NursingProvisionalController::class);
        Route::resource('bilash-provisional', BilashProvisionalController::class);
        Route::resource('kanchan-provisional', KanchanProvisionalController::class);
        ...
        Route::resource('staff-id-card', StaffIdCardController::class);
